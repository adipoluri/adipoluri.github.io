...
function ScreenText({ invert, x = 0, y = 1.2, ...props }) {
  ...
  return (
    <Screen {...props}>
      ...
      <color attach="background" args={[invert ? 'black' : '#ebddc3']} />
      <ambientLight intensity={0.5} />
      <directionalLight position={[10, 10, 5]} />
      <Text font='./inter-Medium.woff' position={[x, y, 0]} ref={textRef} fontSize={4} letterSpacing={-0.1} color={!invert ? 'black' : '#ebddc3'}>
        adi.tech
      </Text>
    </Screen>
  )
...
function ScreenInteractive(props) {
  return (
    <Screen {...props}>
      ...
      <SpinningBox position={[-3.15, 0, 0]} scale={0.5} />
    </Screen>
  )
}
